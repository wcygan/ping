...
ping-server-85f868968-5kf59            1/1     Running   0          82m
ping-server-85f868968-l2jnb            1/1     Running   0          82m
ping-server-85f868968-l5bds            1/1     Running   0          82m

kubectl get deployments
NAME                  READY   UP-TO-DATE   AVAILABLE   AGE
cnpg-cloudnative-pg   1/1     1            1           2m3s
ping-server           3/3     3            3           83m

kubectl get services
NAME                   TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)    AGE
cnpg-webhook-service   ClusterIP   10.100.97.166    <none>        443/TCP    2m11s
kubernetes             ClusterIP   10.96.0.1        <none>        443/TCP    31d
ping-server            ClusterIP   10.101.157.107   <none>        8080/TCP   83m
...
ping-server-85f868968-5kf59            1/1     Running   0          86m
ping-server-85f868968-l2jnb            1/1     Running   0          86m
ping-server-85f868968-l5bds            1/1     Running   0          86m
wcygan@foobar ping % k get pods                                               
NAME                                   READY   STATUS    RESTARTS   AGE
